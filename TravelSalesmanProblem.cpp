...
void test(){
    ...
    cout <<"Genetic Algorithm min path = "<< genetic << endl;
    cout <<"used time = "<< Gene_used_time << endl;
    cout <<"Dynamic Programming min path = "<< optimal << endl;
    cout <<"used time = "<< DP_used_time << endl;
    double error = (double)(genetic - optimal)/optimal;
    cout <<"¬Û¹ï»~®t: "<< error << endl;
}
